...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1.22fr)_minmax(280px,0.78fr)] lg:gap-16">
        ...
        >
          <div className="glass-card relative overflow-hidden p-5 md:p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="rounded-full border border-line/60 bg-bg/40 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-muted">
                Tilt
              </span>
              <span className="rounded-full border border-line/60 bg-bg/40 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-muted">
                Depth
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted">
              A lightweight CSS and motion-driven graphic that reacts to your pointer instead of a
              heavy 3D engine.
            </p>
          </div>
        </motion.div>
